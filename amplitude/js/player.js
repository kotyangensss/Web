...
document.getElementsByClassName('down-header')[0].addEventListener('click', function () {
    ...
    if (list){
        list.style.height = (document.getElementsByClassName('player__container')[0].offsetHeight - 135) + 'px';
    }
...
document.getElementsByClassName('list_screen__meta_container')[0].addEventListener('click', function () {
    document.getElementsByClassName('list_screen')[0].style.display = "none";
...
document.getElementsByClassName('player__middle')[0].addEventListener('click', function () {
    document.getElementsByClassName('player__container')[0].style.display = "none";
    document.getElementsByClassName('playing')[0].style.display = "flex";
});
...
*/
document.getElementsByClassName('song__played__progress')[0].addEventListener('click', function (e) {
