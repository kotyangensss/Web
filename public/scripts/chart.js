function chart() {
    async function requestChart() {
        const request = await fetch("https://shazam.p.rapidapi.com/songs/list-recommendations?key=484129036&locale=en-US", {
            method: "GET",
            headers: {
                "X-RapidAPI-Key": "269cc7f113msh3f0592cb3f033bfp1c01aejsn9bc49e351bdb",
    ...
    async function renderChart() {
        try {
            ...
            document.getElementsByClassName("loading")[0].src = "https://cdn.betterttv.net/emote/61119bfc76ea4e2b9f764aae/3x";
