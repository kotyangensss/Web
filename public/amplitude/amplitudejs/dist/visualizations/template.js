...
function VisualizationObjectName() {
  ...
  */
  ...
  /*
    Start the visualization. Do not overwrite this. This is how the visualization
  ...
  */
  ...
  /*
    Stop the visualization. Do not overwrite this. This gets called when the
    ...
    it can be different from before if needed.
  */
